		...
		<div class="collapse navbar-collapse" id="navbarNav">
			<ul class="nav navbar-nav  ml-auto">
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					...
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">
						...
						<a class="dropdown-item" href="<%=ORSView.CATERING_CTL%>"> <i
							class="fa fa-bed"></i> Add Catering
						</a> <a class="dropdown-item" href="<%=ORSView.CATERING_LIST_CTL%>"><i
							class="fa fa-list"></i>Catering List</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="hostelDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Driver</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.DRIVER_CTL%>"> <i
							class="fa fa-bed"></i> Add Driver
						</a> <a class="dropdown-item" href="<%=ORSView.DRIVER_LIST_CTL%>"><i
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="hostelDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Meeting</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.MEETING_CTL%>"> <i
							class="fa fa-bed"></i> Add Meeting
						</a> <a class="dropdown-item" href="<%=ORSView.MEETING_LIST_CTL%>"><i
							class="fa fa-list"></i>Meeting List</a>
					</div></li>
				...
				<li class="nav-item dropdown" style="padding-left: 5px;"><a
					class="nav-link dropdown-toggle" href="#" id="hostelDropdown"
					role="button" data-toggle="dropdown" aria-haspopup="true"
					aria-expanded="false"> <font style="color: white;">Ticket</font>
				</a>
					<div class="dropdown-menu" aria-labelledby="navbarDropdown">

						<a class="dropdown-item" href="<%=ORSView.TRAINTICKET_CTL%>">
							<i class="fa fa-bed"></i> Book Ticket
						</a> <a class="dropdown-item" href="<%=ORSView.TRAINTICKET_LIST_CTL%>"><i
							class="fa fa-list"></i>Booking List</a>
					</div></li>
